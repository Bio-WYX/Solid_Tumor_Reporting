...
#     return clean_allele
    ...
    def chemo_dict(self):
        ...
        df_info['Index'] = range(df_info.shape[0])
        df_info.set_index(['Index'],inplace=True)
        df_info_dict = df_info.T.to_dict()
